...
FRONTEND_IMAGE="quick-frontend:$RELEASE_TAG"
NGINX_IMAGE="quick-nginx:$RELEASE_TAG"

# Define full registry image names for upload
FRONTEND_REGISTRY_IMAGE="$REGISTRY_BASE/quick-frontend:$RELEASE_TAG"
NGINX_REGISTRY_IMAGE="$REGISTRY_BASE/quick-nginx:$RELEASE_TAG"
